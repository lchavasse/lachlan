...
For this tutorial we’re using Anthropic and [Tavily](https://tavily.com/).
...
![image.png](Getting%20Started%20with%20Langgraph%20Agents%201770a140a5228089a870ebea7d088023/image.png)
...
The full code for the agent can be found here: 

https://github.com/lchavasse/langgraph-tutorial/blob/aa3203c89ac28f8a56935c4a2e6c6ad2f32467ee/basic-ReAct-agent.py
